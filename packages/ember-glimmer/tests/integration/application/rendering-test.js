...
moduleFor('Application test: rendering', class extends ApplicationTest {
  ...
  ['@test when an already rendered property is changed during children\'s rendering'](assert) {
    this.router.map(function() {
    ...
    let expectedBacktrackingMessage = /modified "model.name" twice on \[object Object\] in a single render. It was rendered in "routeWithError" and modified in "component:xFoo"/;
